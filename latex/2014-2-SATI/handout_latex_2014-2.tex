...
\input{conteudo/intro_escrita} % Introdução à escrita científica

\input{conteudo/tex} % TeX ao resgate!

\input{conteudo/instalacao} % Básicos da instalação

\input{conteudo/problemas} % Problemas comuns dos editores WYSIWYG
...
\nocite{_transition}
\bibliography{conteudo/handout_latex}
