...
Na figura~\ref{fig:elementary-install} podemos ver dois ``tipos'' de instalação. A primeira irá apagar todo o HD e instalar o Linux, escolha apenas se quiser \emph{apagar} o Windows, caso contrário escolha a segunda o que nós levará a escolher onde instalar o Linux.
