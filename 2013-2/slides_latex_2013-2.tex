...
\begin{slide}{\Large Os detalhes}
  ...
  {
          \begin{figure}[!h]
            \onslide*{2}{ \includegraphics[scale=.14]{resources/typo}}
            \onslide*{3}{ \includegraphics[scale=.28]{resources/comparison}}
            \onslide*{4-}{ \includegraphics[scale=.4]{resources/readibility}}
          \end{figure}

          \begin{figure}[!h]
            \onslide*{2}{\includegraphics[scale=.5]{resources/ligature}}
          \end{figure}
  }
\end{slide}
...
\begin{slide}{\Large A solução}
  ...
  \twocolumn{
          ...
          \begin{figure}[!h]
            \onslide*{3}{\includegraphics[scale=.16]{resources/taocp}}
          \end{figure}
          \vspace{1.5cm}
  }
  {
          \begin{figure}[!h]
            \onslide*{2}{\includegraphics[scale=.4]{resources/youngknuth}}
            \onslide*{3}{\includegraphics[scale=.3]{resources/knuth}}
            \onslide*{6}{\includegraphics[scale=.3]{resources/lamport}}
          \end{figure}
