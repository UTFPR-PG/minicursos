...
\label{IEEE}\includepdf{contents/intro_writing_conference/intro_writing_ieee.pdf}
\label{SBC}\includepdf[pages=1-]{contents/intro_writing_conference/intro_writing_sbc.pdf}
