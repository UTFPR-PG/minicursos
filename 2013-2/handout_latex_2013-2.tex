...
\input{contents/intro_writing} %Introdução à escrita científica

\input{contents/tex} %TeX ao resgate!

\input{contents/problemas} %Problemas comuns dos editores WYSIWYG (talvez fique apenas na apresentação, acho que essa seção é mais visual)
